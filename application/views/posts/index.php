...
<div class="row">
    ...
    <div class="col-md-9">
        <small class="post-date">Posted at: <?php echo $post['created_at'];?> a(z) <strong><a href="<?php echo base_url().'categories/posts/'.$post['id']?>"><?php echo $post['name'] ?></a></strong>-ban/ben</small>
        <br>
        <div class="post-body">
